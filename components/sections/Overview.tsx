...
const paragraphs = [
  ...
  "For festivals, we create custom festival football jerseys, limited edition festival shirts, crew jerseys, VIP jerseys, sponsor jerseys and merchandise drops that reflect the identity of the event. A festival football shirt can bring together the artwork, location, lineup, crowd, colour palette and story of the festival in one wearable product.",
  ...
  "If you are searching for custom football jerseys, bespoke football shirts, white label football jerseys, private label football shirts, festival football jerseys, artist merch jerseys, creator merch football shirts, event football jerseys, limited edition football shirts, football jersey design, football shirt production or a full concept-to-creation jersey studio, OBRA is built to handle the whole drop.",
];
